...
`Platform` คือ ส่วนที่ Implementation จาก `Domain` และ Libary หรือ framwork อื่นๆ เฉพาะเจาะจงของแต่ละ Platform
รวมถึงการเรียกใช้ API โดยจะแยกโครงสร้างดังนี้
